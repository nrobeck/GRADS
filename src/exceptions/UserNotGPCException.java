...
public class UserNotGPCException extends Exception {
     ...
     * 
     * @param userId
     *            the X500 of the current user of the system at the time the
     *            exception is thrown
     */
	...
	// create the message
	String message = "Only a GPC may use perform this action. The user ID "
		+ invalidID + " is not a valid ID for a GPC in this system.";
	// return the message
	return message;
    }
