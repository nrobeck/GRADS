...
public class GRADS implements GRADSIntf {
     ...
     *            filename of the students database
     * @param coursesFileName
     *            filename of the courses database
     * @param usersFileName
     *            filename of the users database
     */
    public GRADS(String studentsFileName, String coursesFileName,
    ...
    private DataManager dbManager = new DataManager(coursesFile, studentsFile,
	    null, usersFile);
    private TranscriptHandler transcriptHandler = new TranscriptHandler(
	    dbManager);
    private SummaryBuilder summaryBuilder = new SummaryBuilder(dbManager,
	    transcriptHandler);
    private boolean GPC;
     ...
     * 
     * @throws UserNotGPCException
     *             thrown if the current user is not a GPC
     ...
     * 
     * @param userId
     *            the X500 of the user of the system
     * @throws InvalidX500Exception
     *             thrown if userId is not valid in system
     ...
     * 
     * @param userId
     *            the X500 of the student whose transcript is to be retrieved
     * @throws InvalidX500Exception
     *             thrown if userId is invalid
     * @throws UserNotGPCException
     *             thrown if current user is not a GPC
	...
	if (GPC) {
		...
		if (dbManager.getUserByID(userId).getDepartment()
			.equals(currentUser.getDepartment())) {
    ...
    /**
     * Sends modifications to the students transcript for update in the
     * database.
     * 
     * @param userId
     *            the X500 of the student the transcript belongs to
     * @param transcript
     *            the (modified) student record that will be written to the
     *            database
     * @throws InvalidX500Exception
     *             thrown if userId is invalid
     * @throws UserNotGPCException
     *             thrown if current user is not a GPC
     * @see edu.umn.csci5801.GRADSIntf#updateTranscript(java.lang.String,
     *      edu.umn.csci5801.model.StudentRecord)
     */
    @Override
     ...
     * 
     * @param userId
     *            the X500 of the student whose transcript is to have the note
     *            appended
     * @param note
     *            the note to be appended to the student transcript
     * @throws InvalidX500Exception
     *             thrown if userId is invalid
     * @throws UserNotGPCException
     *             thrown if current user is not a GPC
     * @see edu.umn.csci5801.GRADSIntf#addNote(java.lang.String,
     *      java.lang.String)
     */
    @Override
    ...
    /**
     * Return a progress summary assuming the input student has taken the input
     * classes as well as classes they have actually taken.
     * 
     * @param userId
     *            the identifier of the student
     * @param courses
     *            the hypothetical courses to be added to the summary
     * @throws InvalidX500Exception
     *             thrown if userId is invalid
     * @throws UserNotAllowedException
     *             thrown if current user is not a GPC
     * @return progress summary of the user with the input X500 assuming they
     *         have taken the courses listed in the courses parameter
     * @see edu.umn.csci5801.GRADSIntf#simulateCourses(java.lang.String,
     *      java.util.List)
     */
    @Override
