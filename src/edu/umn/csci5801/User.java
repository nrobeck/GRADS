 ...
 * @author Kyle
 * 
 *         Storage class for user information. This is used for user validation
 *         and specifying departments Information is only allowed to be set on
 *         creation This is to reduce mistakes in overriding data;
 * 
 */
public class User {
     ...
     *            the X500 of the user
     * @param role
     *            whether the user is a gpc or a student
     * @param department
     *            what department the user is a member of
     */
    ...
    /**
     * Compares the input object to the current user for equality. If the IDs
     * are the same the object and user are considered equal. ASSUME NO ID
     * DUPLICATES
     * 
     * @param o
     *            the object that the user is to be compared to
     */
    @Override
