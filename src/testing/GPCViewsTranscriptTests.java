...
public class GPCViewsTranscriptTests {
	...
	/**
	 * Tests if a student tries to access a transcript
	 * Test if a GPC of the same Department tries to get a transcript 
	 * Test if a GPC from a different department tries to get the transcript
	 */
	@Test
	public void gpcAccessTests(){
		...
		Assert.assertNotNull("A csci GPC must be able to get a csci student's transcript", transcript);
		...
		Assert.assertNull("A math GPC can not get a csci student's transcript", transcript);
	}
}
